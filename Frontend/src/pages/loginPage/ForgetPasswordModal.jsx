...
const ForgetPasswordModal = (props) => {
  ...
  const handleUpdateOk = async (values) => {
    ...
    try {
      await axios.post(
        "https://sohoj-thikadari-production.up.railway.app:8888/api/v1/auth/updatepassword",
  ...
  const handleOTPOk = async () => {
    ...
    try {
      await axios.post(
        "https://sohoj-thikadari-production.up.railway.app:8888/api/v1/auth/validateotp",
  ...
  const handleForgetEmailOk = async () => {
    ...
    try {
      const response = await axios.post(
        "https://sohoj-thikadari-production.up.railway.app:8888/api/v1/auth/forgotpassword",
        {
          email: modalInput,
          withCredentials: true,
        }
